...
INFILE = './db_dump/data/other-speakers/other-speakers-deduped.json'
OUTFILE = './db_dump/data/other-speakers/other-speakers-final.json'
...
process_file(INFILE, OUTFILE, 'DE')